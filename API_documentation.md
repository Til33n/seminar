...
2.)Za prednji del smo uporabili programski jezik HTML. Z pomočjo dveh datotek "index.html" in "user_stats.html" vršimo API klice (glej              
   podpoglavja 1.1.1. - 1.1.X.). Spletna stran mobilne aplikacije je dostopna na spletnem naslovu http://93.103.156.225
